                        ...
                        <div class="apo-aligner-outer">
                            <div class="apo-aligner-inner">
                                <ul class="apo-striped-photo-categories">
                                    <li>
                                        <a href="{{url('/projects/'.$project->id)}}">{{$project->category_name}}</a>
                                    </li>
                                </ul>
                    ...
                    <div class="apo-grid apo-cols-4">
                        <section class="apo-grid-col">
                            ...
                            <ul class="apo-fullscreen-nav-pages">
                                ...
                                <li class="apo-active"><a href="home_striped.html">Striped Page With Top Transparent
                                        Header</a></li>
                                ...
                                <li><a href="home_slider_with_bottom_dark_header.html">Slider With Bottom Dark
                                        Header</a></li>
                                <li><a href="home_full_page_scroll_with_top_transparent_header.html">Full Page Scroll
                                        With Top Transparent Header</a></li>
