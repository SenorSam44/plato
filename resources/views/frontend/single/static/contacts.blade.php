        ...
        <div class="container">
          <div class="row apo-same-height-container">
            ...
            <div class="col-sm-6 apo-same-height">
              ...
              <!-- Contact Form-->
              {{ Session::get('msg') }}
              <form novalidate="true" class="apo-contact-form" method="post" action="{{URL::to('/messages')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                <ul> 
                  <li> 
                  ...
                  <li> 
                    <div class="apo-moved-label">
                      ...
                      <label for="phone">Phone</label><span class="apo-moved-label-border"></span>
                    </div>
                  </li>
                  <li> 
                    <div class="apo-moved-label">
                      <input type="email" id="email" name="email"/>
                      <label for="email">Email Address</label><span class="apo-moved-label-border"></span>
                    </div>
                  </li>
                  <li> 
                    <div class="apo-moved-label">
                      <input type="subject" id="subject" name="subject"/>
                      <label for="subject">Subject</label><span class="apo-moved-label-border"></span>
                    </div>
                  </li>
                  <li> 
                    <div class="apo-moved-label">
                      <textarea id="message" name="message" rows="1"></textarea>
                      <label for="message">Message</label><span class="apo-moved-label-border"></span>
                    </div>
                  </li>
                  <li>
